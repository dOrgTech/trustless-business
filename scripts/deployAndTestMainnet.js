...
async function main() {
  ...
  console.log("MAINNET: The Grateful Paralized - Deployment & Testing");
  console.log("=".repeat(80));
  ...
  console.log("STEP 4: Creating proposals...\n");
  ...
  let propReceipt = await propTx.wait();
