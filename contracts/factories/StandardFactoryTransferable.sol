...
/**
 * @title StandardFactoryTransferable
 * @notice Deploys standard DAOs with TRANSFERABLE tokens (always)
 * @dev No transferability parameter - tokens are ALWAYS transferable
 */
contract StandardFactoryTransferable {
    ...
    /**
     * @notice Deploys a DAO with TRANSFERABLE tokens
    ...
    function deployDAOwithToken(DaoParams memory params) public payable {
        ...
        // 3. Deploy TRANSFERABLE RepToken
